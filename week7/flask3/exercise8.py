...
class InfoForm(FlaskForm):
    department = StringField('What is your department?',
                             validators=[DataRequired()])
    graduated = BooleanField('Did you Graduate?')
    degree = RadioField('Please choose your degree: ', choices=[
                        ('level_one', 'Undergrad'), ('level_two', 'Graduate')])
    job_choice = SelectField('Where do you want to work?', choices=[
                             ('job1', 'Industry'), ('job2', 'Academia')])
